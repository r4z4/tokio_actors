...
mod tests {
    ...
    fn unequal_lengths_return_none() {
        let x_eg: Record = Record { name: "Name".to_owned(), count: 44, quote: "What".to_owned() };
        let y_eg: Record = Record { name: "Jim".to_owned(), count: 3, quote: "Huh".to_owned() };
        let y_long_eg: LongerRecord = LongerRecord { name: "Steve".to_owned(), count: 2, quote: "Whater".to_owned(), extra_quote: "Whaterer".to_owned() };
